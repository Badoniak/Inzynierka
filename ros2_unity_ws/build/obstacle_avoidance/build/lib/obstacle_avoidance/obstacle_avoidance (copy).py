...
class ObstacleAvoidance(Node):
    def __init__(self):
        ...
        self.declare_parameter('safe_distance', 2.5)  # meters - distance to keep from obstacles
        self.declare_parameter('danger_distance', 2.0)  # meters - critical distance to stop
    ...
    def analyze_scan(self):
        ...
        front_mask = (valid_angles <= math.pi/18) | (valid_angles >= 6.108652382)
        # Left: 10° to 120°
        left_mask = (valid_angles > math.pi/18) & (valid_angles <= 2.0943951024)

        # Right: 240° to 350°
        right_mask = (valid_angles > 4.1887902048) & (valid_angles < 6.108652382)
